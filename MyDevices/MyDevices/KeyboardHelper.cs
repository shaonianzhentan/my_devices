...
namespace MyDevices
{
    class KeyboardHelper
    {
        ...
        public static void win_keypress(byte bVk)
        {
            keybd_event(vbKeyWinL, 0, 0, 0);
            keybd_event(bVk, 0, 0, 0);
            keybd_event(bVk, 0, 2, 0);
            keybd_event(vbKeyWinL, 0, 2, 0);
        }
        ...
        public const byte vbKeyWinL = 91;
        public const byte vbKeyWinR = 92;
